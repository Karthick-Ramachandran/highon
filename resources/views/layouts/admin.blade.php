...
<head>
    ...
    <title>Jobs on High - Admin</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="{{ route('dubai') }}">
                    ...
                    <span>Dubai</span>
                </a> <a class="nav-link" href="{{ route('malaysia') }}">
                    <i class="fa fa-building"></i>
                    <span>Malaysia</span>
                </a> <a class="nav-link" href="{{ route('qatar') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('/admin/employer/list') }}">All Companies</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class=" img-profile rounded-circle" src="{{ asset('avatar.svg') }}">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Jobs on high 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
