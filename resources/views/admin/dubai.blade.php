...
<div class="text-center">
    <h2>Search Employees in Dubai</h2>
</div>

<div class="mt-3 mb-3 row justify-content-center">
    <form method="GET" action="{{ route('countrysearch', ['country' => 'Dubai']) }}">
        <div class="input-group">
            <input type="text" name="position" class="form-control bg-light" aria-label="Search" placeholder="Type designation and enter" aria-describedby="basic-addon2">
        </div>
    </form>
</div>
