...
<div class="card container ">
    <div class="card-description">
        <form action="/admin/subs" class="mt-4" method="POST">
            @csrf
            <div class="form-group">
                <label for="coupon_code">Create Job Category</label>
                <input class="form-control" type="text" name="subs" placeholder="Category" required>
            </div>
...
<div class="row justify-content-center">
    ...
    <div class="col-xl-4 col-ls-4 col-md-6 col-sm-12 col-xs-12">
        <div class="card mt-2">
            <div class="card-body">
                <h4 class="card-title">{{ $user->subs }}</h4>
                <div class="row justify-content-center">
                    <a href="/admin/delete/subs/{{ $user->id }}" class="btn btn-danger"> Delete </a>
                </div>
            </div>
        </div>
    </div>
